...
<body>
  ...
  <a href="v_tambah_pengguna_baru.php" class="btn btn-primary">Tambah Pengguna</a>
  <br><br>
  <table border="1" class="table table-hover">
    ...
    ?>
      <tr>
        ...
        <td><a href="v_ubah_pengguna.php?id_login=<?= $pengguna['id_login'] ?>" class="btn btn-warning">Ubah</a></td>
      </tr>
    <?php } ?>
  </table>
  </div>
