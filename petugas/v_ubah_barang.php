  ...
  <form action="m_ubah_barang.php" method="post">
    ...
    <table class="table table-hover">
      <tr>
        <td>Nama Barang</td>
        <td>:</td>
        <td><input type="text" name="nama_barang" id="" value="<?= $barang['nama_barang'] ?>" readonly style="background-color: grey;"></td>
      </tr>
      <tr>
        <td>Stok Barang</td>
        <td>:</td>
      ...
      <tr>
        <td>Harga</td>
        <td>:</td>
        <td><input type="text" name="harga_barang" id="" value="<?= $barang['harga_barang'] ?>" readonly style="background-color: grey;"></td>
      </tr>
      <tr>
        <td></td>
        <td></td>
