...
<body>
  ...
  <div class="container">
  <center><h1>Penjualan</h1></center> <br>
  <?php
  //ambil koneksi
  include "../config.php";
  ...
  <div class="card-body">
    <h3>Identitas pelanggan</h3> <br>
    <p class="card-text">ID Pelanggan : <b><?= $pelanggan['id_pelanggan'] ?></b></p>
    <p class="card-text">Nama Pelanggan : <?= $pelanggan['nama_pelanggan'] ?></p>
    <p class="card-text">Alamat Pelanggan : <?= $pelanggan['alamat_pelanggan'] ?></p>
    <p class="card-text">No telp Pelanggan : <?= $pelanggan['telepon_pelanggan'] ?></p>
  </div>
</div>
      <!-- tambah barang -->
      <br>
